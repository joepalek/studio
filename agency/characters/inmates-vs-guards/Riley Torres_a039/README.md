...
**ID:** char-spec-agent-20260403-039
**Universe:** inmates-vs-guards
**Archetype:** informant
**Status:** ungraded
**Created:** 2026-04-04T05:30:43.417479

## Quick Reference

- **Profile:** riley_torres_a039-profile.json
- **Backstory:** riley_torres_a039-backstory.md
- **Media Log:** logs/riley_torres_a039-media-log.json
- **Interaction Log:** logs/riley_torres_a039-interaction-log.json
- **Appearances:** logs/riley_torres_a039-appearances.json
