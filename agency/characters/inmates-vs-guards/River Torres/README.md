...
**ID:** char-spec-gemini-031
**Universe:** inmates-vs-guards
**Status:** ungraded
**Created:** 2026-03-30T13:07:43.117860

## Quick Reference

- **Profile:** river_torres-profile.json
- **Backstory:** river_torres-backstory.md
- **Media Log:** logs/river_torres-media-log.json
- **Interaction Log:** logs/river_torres-interaction-log.json
- **Appearances:** logs/river_torres-appearances.json
