...
**ID:** char-spec-gemini-088
**Universe:** original-fiction
**Status:** ungraded
**Created:** 2026-03-30T13:07:55.247756

## Quick Reference

- **Profile:** sam_o'brien-profile.json
- **Backstory:** sam_o'brien-backstory.md
- **Media Log:** logs/sam_o'brien-media-log.json
- **Interaction Log:** logs/sam_o'brien-interaction-log.json
- **Appearances:** logs/sam_o'brien-appearances.json
