...
**ID:** char-spec-agent-021
**Universe:** original-fiction
**Archetype:** lover
**Status:** ungraded
**Created:** 2026-03-30T13:14:52.339763

## Quick Reference

- **Profile:** river_anderson_a021-profile.json
- **Backstory:** river_anderson_a021-backstory.md
- **Media Log:** logs/river_anderson_a021-media-log.json
- **Interaction Log:** logs/river_anderson_a021-interaction-log.json
- **Appearances:** logs/river_anderson_a021-appearances.json
