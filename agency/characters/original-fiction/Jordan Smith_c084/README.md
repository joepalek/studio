...
**ID:** char-spec-claude-084
**Universe:** original-fiction
**Archetype:** caregiver
**Status:** ungraded
**Created:** 2026-03-30T13:14:14.127893

## Quick Reference

- **Profile:** jordan_smith_c084-profile.json
- **Backstory:** jordan_smith_c084-backstory.md
- **Media Log:** logs/jordan_smith_c084-media-log.json
- **Interaction Log:** logs/jordan_smith_c084-interaction-log.json
- **Appearances:** logs/jordan_smith_c084-appearances.json
