...
**ID:** char-spec-gemini-053
**Universe:** original-fiction
**Archetype:** mentor
**Status:** ungraded
**Created:** 2026-03-30T13:14:32.670350

## Quick Reference

- **Profile:** riley_anderson_g053-profile.json
- **Backstory:** riley_anderson_g053-backstory.md
- **Media Log:** logs/riley_anderson_g053-media-log.json
- **Interaction Log:** logs/riley_anderson_g053-interaction-log.json
- **Appearances:** logs/riley_anderson_g053-appearances.json
