...
**ID:** char-spec-gemini-073
**Universe:** original-fiction
**Status:** ungraded
**Created:** 2026-03-30T13:07:51.817696

## Quick Reference

- **Profile:** riley_o'brien-profile.json
- **Backstory:** riley_o'brien-backstory.md
- **Media Log:** logs/riley_o'brien-media-log.json
- **Interaction Log:** logs/riley_o'brien-interaction-log.json
- **Appearances:** logs/riley_o'brien-appearances.json
