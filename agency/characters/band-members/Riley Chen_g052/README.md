...
**ID:** char-spec-gemini-052
**Universe:** band-members
**Archetype:** drummer
**Status:** ungraded
**Created:** 2026-03-30T13:14:32.388859

## Quick Reference

- **Profile:** riley_chen_g052-profile.json
- **Backstory:** riley_chen_g052-backstory.md
- **Media Log:** logs/riley_chen_g052-media-log.json
- **Interaction Log:** logs/riley_chen_g052-interaction-log.json
- **Appearances:** logs/riley_chen_g052-appearances.json
