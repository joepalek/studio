...
**ID:** char-spec-claude-086
**Universe:** band-members
**Archetype:** drummer
**Status:** ungraded
**Created:** 2026-03-30T13:14:14.415719

## Quick Reference

- **Profile:** morgan_miller_c086-profile.json
- **Backstory:** morgan_miller_c086-backstory.md
- **Media Log:** logs/morgan_miller_c086-media-log.json
- **Interaction Log:** logs/morgan_miller_c086-interaction-log.json
- **Appearances:** logs/morgan_miller_c086-appearances.json
